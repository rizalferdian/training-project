...
class Kota extends MY_Controller {
  ...
  public function create_import()
  {
    ...
    if($validation == false){
      ...
      if (!$this->upload->do_upload('file')) {
        ...
        $dataKota = $this->M_kota->read();
        
        error_reporting(E_ALL);
        include_once './assets/phpexcel/Classes/PHPExcel/IOFactory.php';
  ...
  {
    $data['form'] = base_url('kota/create_import');
    
    $this->load->view('kota/form_import', $data);
  }
