<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <form class="form-horizontal" method="post" action="<?php echo base_url("nilai/act_edit"); ?>">
    <div class="form-group">
      ...
      <div class="col-sm-10">
        ...
        <select name="id_siswa" id="id_siswa" class="form-control">
          ...
          <option value="<?php echo $value->id; ?>" <?php if($data_nilai->id_siswa == $value->id){echo "selected";} ?>><?php echo $value->nama; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <select name="id_mapel" id="id_mapel" class="form-control">
          ...
          <option value="<?php echo $value->id_mapel; ?>" <?php if($data_nilai->id_mapel == $value->id_mapel){echo "selected";} ?>><?php echo $value->nama_mapel; ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" name="total_nilai" class="form-control" id="total_nilai" placeholder="Jumlah Nilai" value="<?php echo $data_nilai->total_nilai; ?>">
      </div>
    </div>
    <div class="form-group">
